                ...
                {rows.map((r, i) => {
                  ...
                  return (
                    <tr key={i} style={{ borderBottom: '0.5px solid #eee' }}>
                      <td style={{...tdS, cursor: 'pointer', color: 'var(--accent)', textDecoration: 'underline dotted', textUnderlineOffset: 3}} onClick={() => { window.location.href = `#/reports?category=${encodeURIComponent(r.cat)}` }}>{r.cat}</td>
